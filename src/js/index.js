...
const PROJECTS = {
  wordleClone : {
    ...
    rickAndMorty : {
      name : 'Rick And Morty',
      score : [],
      liveUrl : 'https://rick-project-jonnier.netlify.app/',
      githubUrl : 'https://github.com/jonniermartinez/Rick',
      img : './src/img/Rick.jpg'
    },
    twitterClone : {
      name : 'Twitter Clone',
      score : [],
      liveUrl : 'https://twitter-clone-jonnier.netlify.app/',
      githubUrl : 'https://github.com/jonniermartinez/twitter-clone',
      img : './src/img/twiteer.jpg'
    }
  }
